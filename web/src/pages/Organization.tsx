...
import { CodeCategoryType, CodeType, OmbudsType, OrganizationType } from '../types/majorTypes'
...
export function Organization() {
    ...
    const userId = 'b73d0105-af49-484f-87a3-217af3feff90'
    ...
    const codeCategoryRes = useGetter<CodeCategoryType[]>(['get_code_categories_by_organization_id', organizationId])
